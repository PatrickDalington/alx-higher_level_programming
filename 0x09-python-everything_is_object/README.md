...
So far in this project, I have learnt instantiation in python programing and learning
more about variable aliasing, object identifier, types and mutability.
Most of the answers to this quiz are provided in `.txt` files.
