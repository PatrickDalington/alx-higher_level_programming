...
The learning of python classes and objects continues in this project. So far so good, practicing and solving probles 
in this project have helped me to use the special `__str__` and `__repr__` methods.
